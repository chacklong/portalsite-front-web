                ...
                <div class="row row-grid align-items-center">
                    ...
                    <div class="col-md-6 order-md-1">
                        <div class="pr-md-5">
                            ...
                            <h3>信息安全</h3>
                            <p>我们的愿景是成为IT技术服务行业的领军企业，为客户提供最优质的服务和最先进的技术支持.</p>
                            <ul class="list-unstyled mt-5">
                                <li class="py-2">
                                    ...
                                    <!-- <p class="mb-0 text-p">我们拥有多年的IT技术服务经验，能够为客户提供全方位的IT服务支持</p> -->
                                </li>
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-satisfied"></badge>
                                        <h6 class="mb-0">技术精湛</h6>
                                    </div>
                                    <!-- <p class="mb-0 text-p">我们拥有多年的IT技术服务经验，能够为客户提供全方位的IT服务支持</p> -->
                                </li>
                                <li class="py-2">
                ...
                <div class="row row-grid align-items-center">
                    ...
                    <div class="col-lg-6 order-lg-1">
                        <div class="d-flex px-3">
                            ...
                            <div class="pl-4">
                                <h4 class="display-3 text-white">解决方案</h4>
                        ...
                        <card shadow class="shadow-lg--hover mt-5">
                            <div class="d-flex px-3">
                                <div>
                                    <icon name="ni ni-satisfied" gradient="primary" color="white" shadow rounded></icon>
                                </div>
                                <div class="pl-4">
                                    <h5 class="title text-primary">formulate a scheme</h5>
                                    <p>参与制定方案并执行项目管理和改造工作</p>
                                    <a href="#" class="text-primary">了解更多</a>
                                </div>
                            </div>
                        </card>
                        <card shadow class="shadow-lg--hover mt-5">
                            <div class="d-flex px-3">
                                <div>
                                    <icon name="ni ni-active-40" gradient="primary" color="white" shadow rounded></icon>
                                </div>
                                <div class="pl-4">
                                    <h5 class="title text-primary">formulate a scheme</h5>
                                    <p>参与制定方案并执行项目管理和改造工作</p>
