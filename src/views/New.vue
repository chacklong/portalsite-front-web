...
export default {
    ...
    async created(){
        try{
            ...
            this.newsDetail.newtitle = res.data.attributes.newtitle
            this.newsDetail.newcontent = res.data.attributes.newcontent
            this.newsDetail.newdate = res.data.attributes.newdate
